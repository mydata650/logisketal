    ...
    return (
        <aside>
            <div className="row pl-4 ">
                ...
                <div className="col-xs-4  pl-1 text-info"><span className="h2 tempFontPrincess"> games</span> <span className=" tempFontOpenSans small">(5 years)</span></div>
                <div className="col-xs-6"></div>
            </div>
            <div className="row border-bottom px-2">
                <div className="col-xs-12 small">Here will be list of games for 5 years old students.... </div>
            </div>
        </aside>
    )
}
